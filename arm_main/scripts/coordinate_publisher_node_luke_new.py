...
def CoordinateIdentification():
    ...
    try:
        ...
        # cv2.circle(img,center = (width // 2, height // 2) , radius = 130 , color = 0, thickness = 10)
        # print(int(min(height, width) / 1.4)-115)
        ...
        color_dist = {'red': {'Lower': np.array([172, 73, 71]), 'Upper': np.array([179, 255, 255])},
